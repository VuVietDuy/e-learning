...
import { DeleteOutlined, EditOutlined, MailOutlined, PlusOutlined, SearchOutlined, StarFilled } from '@ant-design/icons';
import './style.scss'
...
export function InstructorManagement() {
  const columns : ColumnsType<DataType> = [
    ...
    },
    {
      ...
      <>
        {dataIndex.topic.map((item: string) => (<Tag color={`${randomColor()}`}>{item}</Tag>))}
      </> 
    },
    {
      title: 'Course',
  ...
  <div className='instructor_management'>
    <div className='d_flex justify_content_between mb_4'>
        ...
        <div>
            <Button type='primary' size='large'><PlusOutlined /> Add new instroctor</Button>
        </div>
    </div>
