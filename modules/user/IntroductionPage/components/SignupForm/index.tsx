    ...
    <Form onFinish={handleSignup}>
      <div className="SignupForm">
        ...
        <input
          className="passcode"
          type="text"
          placeholder="HJAKA - HFDJK - HDJKS - KIJLM"
        />
        <p>
          By signing up you agree to GraFish’s <a href="">Terms of Service</a>
          &nbsp; & &nbsp; <a href="">Privacy Policy</a>. This page is protected
          by reCAPTCHA and is subjected to Google’s Team
        </p>
