      ...
      <div className="Withdraw">
        <Form>
          <div className="UserInfo">
            <div className="top">
              <div className="bigTitle">Withdraw Money</div>
              ...
              <div className="country-zipcode">
                <div>
                  ...
                  <button className="chooseCountry">
                    <GlobalOutlined />
                    VietNam
              ...
              <div className="note">
                MegaSkill is required by law to collect applicable transaction
                or taxes for purchases made in certain tax jurisdictions
              </div>
            </div>
        ...
        <div className="CompleteWithdraw">
          ...
          <div className="agree">
            By completing your withdraw you agree to our{" "}
            <span className="term">Terms of Service</span>
          </div>

          <button className="confirmWithdraw" onClick={() => openConfirm()}>
            Completed Withdraw
          </button>
