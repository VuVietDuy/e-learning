...
import { Button, DatePicker, DatePickerProps, Rate, Select, TimePicker } from 'antd';
  ...
  return (
    <div className='Performance'>
      ...
      <div className="Body">
        ...
        <div id = "revenue" className={`Revenue ${activeTab === "revenue" ? "d_block" : "d_none"}`}>
          ...
          <div className="lineGraph">
            ...
            <div className="export-withdraw">
              <Button className='export' size='large'>Export Revenue Report</Button>
              <Button className='withdraw bg_green' size='large'>Withdraw Money</Button>
          </div>
          </div>
          
        </div>
        
        <div id = "students" className={`Students ${activeTab === "students" ? "d_block" : "d_none"}`}>
          <div className="getTop">See people taking your course</div>
          <div className="student-statistic">
            <div className='studentNum'>20 <span className="students-text">Students</span></div>
            <div>Region: <button className='region-button'>America <DownOutlined></DownOutlined></button></div>
            <div>Country: <button className='country-button'>United States <DownOutlined></DownOutlined></button></div>
          </div>
        ...
        <div id = "review"  className={`Reviews ${activeTab === "review" ? "d_block" : "d_none"}`}>
