  ...
  return (
      ...
      <div className="homePage">
        ...
        <div className="part2">
            ...
            <div className="text font18 p-24">When you helps others along their their creative journey, it’s rewarding in more ways than one.</div>
        ...
        <div className="part3">
           ...
           <img src="/img/img4.png" alt="" className="img-float" />
            <div className="part3-content">
                <div className="text font28 bold pt-88">Teaching on MegaSkill helped Marry Jones see her worl in a whole new way, and inspire members all over the world.</div>

                <div className="text font16 p-24">Meet Marry Jones McDonald, Zbrush For Character Artists</div>
            ...
            <div className="list-ques">
              <div className="item-ques">
                <div className="item-ques-contain">
                  ...
                  <div className="as-ques">GraFish is an online learning community with thousands of classes for creative and curious people, on topics including illustration, design, photography, video, freelancing, and more. On Skillshare, you’ll find inspiration from hands-on classes and teachers at the top of their creative fields, so you can take the next step in your creative journey.</div>
                </div>
